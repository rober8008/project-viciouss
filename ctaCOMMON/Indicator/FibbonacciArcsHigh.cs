...
{
    public class FibbonacciArcsHigh : Shape_Indicator
    {
        public FibbonacciArcsHigh() { this.In_Main_Chart = true; }
        public FibbonacciArcsHigh(List<Candel> Data_Source, DateTime start_date, DateTime end_date, double start_value, double end_value, string color, string name)
        ...
        public override void ApplyFormula()
        {
            ...
            Line rect0618 = new Line(quotesRange, this.Start_Date, this.End_Date, minimun, (maximun - (0.618 * C)), this.Color, this.Name + "(0.618)", SerieType.dashed);
            Line rect05 = new Line(quotesRange, this.Start_Date, this.End_Date, minimun, (maximun - (0.5 * C)), this.Color, this.Name + "(0.5)", SerieType.dashed);
            Line rect0382 = new Line(quotesRange, this.Start_Date, this.End_Date, minimun, (maximun - (0.382 * C)), this.Color, this.Name + "(0.382)", SerieType.dashed);
