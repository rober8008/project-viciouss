...
{
    public class ROC : Chart_Indicator
    {
        public int Rounds { get; private set; }
        public string Serie_Color { get; private set; }
        public string Serie_Hundred_Color { get; private set; }

        public ROC(List<Candel> data_source, int rounds, string serie_color, string serie_hundred_color): base(data_source)
        {
            this.Name = "ROC";
        ...
        public override void ApplyFormula()
        {
            ...
            Serie serie = new Serie() { Color = this.Serie_Color, Serie_Type = SerieType.line, Column_Data_Label = "ROC " + this.Rounds, Column_Serie_ID = "rocs" };
            ...
            Serie hundred_serie = new Serie() { Color = this.Serie_Hundred_Color, Serie_Type = SerieType.line, Column_Data_Label = "Hundred", Column_Serie_ID = "roch" };
