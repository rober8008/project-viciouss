...
{
    public class StochasticOscillatorFast : Chart_Indicator
    {
        ...
        public StochasticOscillatorFast(List<Candel> data_source, int rounds, int oversold, int overbought, string serie_color, string serie_bounded_lines_color, string serie_average_color): base(data_source)
        {
            this.Name = "Stochastic Oscillator Fast";
        ...
        public StochasticOscillatorFast()
        {
